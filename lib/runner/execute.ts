...
import { extractObjetivo, isoNow } from '../../motor/cdl'
import type { Card, Fields, ImplementResult, StepMap, StepMetric, Usage } from '../../motor/cdl'
import { CARD_BUDGET_USD, cardsDir, CLARIFY, EVAL, quotaFallbackLigado, VERIFY_MODEL, VISUAL_AI } from '../../motor/cdl/ali/config'
...
import { evaluate } from '../../motor/cic/crv/avaliar'
import { readCard, patchCard, repoPath, repoBase } from '../../motor/cdl/store'
import { ensureWorktree, refreshFromBase, runGit, settleWorktree, stageAll, worktreeOnBranch, worktreePath } from '../../motor/qlb/git'
import type { WorktreeFate } from '../../motor/qlb/git'
import { ensureUrl, hasDevServer, inspectUrl, urlPort, stopUrl } from '../../motor/cic/crv/url-viva'
import { classifySurface, pedeUrl, type SurfaceVerdict } from './classify'
import { instrucaoDeAjuste, instrucaoDeConserto, relatoDoAjuste, subirUrlComAjuste, esperarPorPid, subirNoWorktree } from '../../motor/cic/rpr/url-ajuste'
import { implement, verifyVisual } from '../../motor/cic/agente'
...
import { applyFailurePolicy } from '../../motor/cic/rpr/politica'
