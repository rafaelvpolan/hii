...
import type { Card, FailureClass, ImplementResult, VerifyResult } from '../../motor/cdl'
import { cardsDir, ROOT, RUN_TIMEOUT_MS, PROJECT_MEMORY } from '../../motor/cdl/ali/config'
import { isProviderName, modelFor, providerFor, effortFor, modoFor } from '../../motor/tmd/registro'
import { sumTokens } from '../../motor/tmd/uso'
import { classifyFailure } from '../ai/failure'
import type { AiProvider } from '../../motor/tmd/tipos'
import { conectorExterno, navegacaoSemantica } from '../../motor/tmd/pnt/mcp'
...
import { repoPath } from '../../motor/cdl/store'
import { runProvider } from '../../motor/euc/tsr/confianca'
import { markProviderSubstituted } from '../../motor/tmd/confianca'
