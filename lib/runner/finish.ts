...
import type { StepMap, StepMetric } from '../../motor/cdl'
import { CARD_BUDGET_USD, MAX_CONFLICT, maxReajuste, PROJECT_MEMORY } from '../../motor/cdl/ali/config'
...
import { updateRunSteps } from '../../motor/euc/registros'
import { runCodefoxGate, runGatedReview, persistGate, buildPrBody, gateOutcome, gateHaltReason, withGateRetry } from './codefox-gate'
import { ensureContract } from '../../motor/cdl/bss/armazenar'
import { podeAbrirPr } from '../../motor/euc/rdr/doctor'
import { affectedPackage } from './commands'
import { addMetric, accumulatedTotals, haltForInspection, applyStepFailurePolicy } from '../../motor/euc/metricas-de-fecho'
