import { readCard, allCards, normalizeId, listRepos, repoPath } from '../../motor/cdl/store'
import * as core from './actions'
import { planejarLote, removerLote } from '../../motor/cdl/remover'
...
import { agentRoles, isProviderName, providerNameFor } from '../../motor/tmd/registro'
import { COMANDO_DE_LOGIN, provedoresDisponiveis } from '../../motor/tmd/disponibilidade'
import { comandosDaIaAtiva } from '../../motor/tmd/map/comandos'
import type { AgentRole, AiProviderName } from '../../motor/tmd/tipos'
