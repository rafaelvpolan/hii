...
export const DEFAULT_STEPS: PipelineStep[] = [
  ...
  { id: 'limpeza', label: 'Limpeza', kind: 'cleanup', agent: 'pura', state: 'CLEANED', gate: 'none', enabled: true, needs: ['testes', 'seguranca'], instruction: 'Remova comentarios de prosa do codigo alterado (preserve licenca, diretivas de tooling, TODO/ticket).' },
]
