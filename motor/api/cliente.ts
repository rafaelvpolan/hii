...
export function clienteHii(base: string, token: string) {
  ...
  return {
    ...
    configurar: (ajuste: { versao: 1; papel: string; provider?: string; model?: string; effort?: string; modo?: string; gauntlet?: boolean; autoReview?: boolean; revisao?: PoliticaDeRevisao }, chave: string, etag: string) => post<Json>('/v1/configuracao', ajuste, chave, etag),
