...
import { claudeAutenticado, planoDoClaude } from '../../euc/tsr/planos.ts'
export { agentsArgv, claudeArgv, toolsFor } from './claude-argv.ts'
import { run } from '../../qlb/git.ts'
import { emptyUsage } from '../uso.ts'
import { COST_UNKNOWN, readReportedCost } from '../../euc/tsr/custo.ts'
...
import { GATE_MODEL, VERIFY_MODEL } from '../../cdl/ali/config.ts'
