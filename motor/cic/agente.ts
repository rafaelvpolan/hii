...
import { agentesNexusPor } from '../../lib/ai/agentes-nexus'
import type { AgenteInjetado } from '../../lib/ai/agentes-nexus'
...
import { readProjectMemory } from '../../lib/runner/memory'
import { readContract } from '../cdl/bss/armazenar'
import { DESIGN_SYSTEM_BRIEF } from '../../lib/runner/design'
