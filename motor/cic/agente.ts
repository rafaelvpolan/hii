...
import { isProviderName, modelFor, providerFor, effortFor, modoFor } from '../tmd/registro.ts'
import { sumTokens } from '../tmd/uso.ts'
import { classifyFailure } from './rpr/classe-de-falha.ts'
import type { Harness } from '../tmd/tipos.ts'
import { conectorExterno, navegacaoSemantica } from '../tmd/pnt/mcp.ts'
import { agentesNexusPor } from '../agentes/registro.ts'
import type { AgenteInjetado } from '../agentes/registro.ts'
import { readProjectRules } from '../cdl/ali/home.ts'
import { repoPath } from '../cdl/store.ts'
import { runProvider } from '../euc/tsr/confianca.ts'
import { markProviderSubstituted } from '../tmd/confianca.ts'
import { readProjectMemory } from '../csd/memoria.ts'
import { readContract } from '../cdl/bss/armazenar.ts'
import { DESIGN_SYSTEM_BRIEF } from '../agentes/tsl/design.ts'
import { clarifyAnswersPrompt } from '../agentes/clr/clarificar.ts'
import { refPaths, resolveRefs } from '../qlb/alf/refs.ts'
import { markRefsRefused } from '../qlb/alf/confianca.ts'
