import { readCard, allCards, normalizeId, listRepos, repoPath } from '../cdl/store'
import * as core from './acoes'
import { planejarLote, removerLote } from '../cdl/remover'
...
import { newSession, seguir, foraDaTarefa, planShown, removendo, respondido, escolhendoRepo, aprovando, comentando, semAprovacao, comConversa } from './sessao'
import { alvoDeRef, comandoRef } from './refs-comando'
import { migrarRefsDaSessao, limparSessao } from '../qlb/alf/anexo'
import { reiniciarSessao, sessaoAtual } from '../euc/sessao'
import type { Effect, SessionState } from './sessao'
