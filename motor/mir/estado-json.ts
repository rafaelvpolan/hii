...
import { readClarify } from '../agentes/clr/clarificar.ts'
import { usoDeDisco } from '../euc/estado-em-disco.ts'
import type { UsoDeDisco } from '../euc/estado-em-disco.ts'
import { daemonPid, daemonStatus } from '../osw/mtr/daemon.ts'
import { lerCota } from '../euc/tsr/cota.ts'
import type { LeituraDeCota } from '../euc/tsr/cota.ts'
import { lerSaudeDoMotor } from '../euc/rdr/saude.ts'
import type { SaudeDoMotor } from '../euc/rdr/saude.ts'
import { historicoDeSessoes } from './historico.ts'
import type { Sessao } from './historico.ts'
import { esperaHumano, isActive, phaseIndex, phaseLabel, waitsHuman } from './render/phases.ts'
import { passosDe } from '../nmy/passos.ts'
