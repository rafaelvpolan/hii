...
import { reposFile } from '../../cdl/ali/config'
import { repoPath, repoRegistered } from '../../cdl/store'
import { chaveDaSessao, historicoDeSessoes, repoDoCard, sessaoPorChave } from '../historico'
import { avisoDeEstadoVazio, lerEstadoVazio } from '../estado-vazio'
import { renderHistorico } from '../render/historico'
import { renderConfig } from '../render/config'
import { seguimento } from './tela-tarefa'
import { emExecucao, esperandoVoce } from '../render/rodape'
import { pendencia } from '../responder'
import { complete } from '../completar'
import { lerConfig, ordemDaConfig } from '../../cdl/ali/snapshot'
import { agentRoles, providerNameFor, providerNames } from '../../tmd/registro'
import { modelosDe } from '../../tmd/catalogo'
import { modosDoProvedor } from '../../tmd/modos'
import { ESFORCOS } from '../../tmd/preferencias'
