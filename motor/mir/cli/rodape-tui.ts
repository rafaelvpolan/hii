...
import type { DailySpend } from '../../euc/tsr/lacuna'
import { effortFor, modelFor, modoFor, providerNameFor } from '../../tmd/registro'
import { emExecucao, esperandoEmOutrosProjetos, esperandoVoce, linhaDeOutrosProjetos, linhaPropriedades, linhasEspera, linhasExecucao } from '../render/rodape'
import { ESFORCO_PADRAO } from '../../tmd/preferencias'
import { usoDeDiscoCacheado } from '../../euc/estado-em-disco'
import { cardsPerguntando } from '../responder'
import { ultimoAgente } from '../atividade'
import type { SessionState } from '../sessao'
import type { CorpoContexto } from '../tui/app'
