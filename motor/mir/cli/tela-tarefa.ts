...
import { readCard, repoPath } from '../../cdl/store'
import { hasDevServer } from '../../cic/crv/url-viva'
import { buildPlan } from '../../nmy/luc/plano'
import { renderPlan } from '../render/plan'
import { renderCabecalhoTarefa } from '../render/tarefa'
import { renderProcessos } from '../render/processos'
import { renderPendencia } from '../render/pendencia'
import { idadeDe } from '../render/board'
import { readRunSteps } from '../../euc/registros'
import { extractObjetivo } from '../../cdl'
import { subPrompts } from '../instruir'
import { formatar, ultimaAcao, ultimoAgente } from '../atividade'
