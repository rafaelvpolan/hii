...
import { appendProjectMemory } from '../../../lib/runner/memory'
...
import { SUFIXO_DO_GATE, runGatedStep } from '../../../lib/runner/gated'
import { updateRunSteps } from '../../euc/registros'
import { runCodefoxGate, runGatedReview, persistGate, buildPrBody, gateOutcome, gateHaltReason, withGateRetry } from '../../../lib/runner/codefox-gate'
import { ensureContract } from '../../cdl/bss/armazenar'
import { podeAbrirPr } from '../../euc/rdr/doctor'
import { affectedPackage } from '../../../lib/runner/commands'
import { addMetric, accumulatedTotals, haltForInspection, applyStepFailurePolicy } from '../../euc/metricas-de-fecho'
import { buildWithReajuste, testGate } from '../../../lib/runner/finish-gates'
import type { RunCtx } from '../../../lib/runner/finish-gates'
