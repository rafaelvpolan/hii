...
import { lerCota } from '../euclides/tesouro/cota.ts'
import type { LeituraDeCota } from '../euclides/tesouro/cota.ts'
import { lerSaudeDoMotor } from '../euclides/radar/saude.ts'
import type { SaudeDoMotor } from '../euclides/radar/saude.ts'
