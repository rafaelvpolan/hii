...
import { cabeNoDisco, dirDaSessao, garantirDir, MAX_REFS_POR_TAREFA, mb, refsDir, usoDeDisco } from '../euclides/estado-em-disco.ts'
import { textoDoDisco } from './render/disco.ts'
import { anexarNaSessao, anexarNaTarefa, ehUrlDeRef, escreverFontes, fontesDaSessao, proximoBaseLocal } from '../quilombo/alfandega/anexo.ts'
import type { Anexo } from '../quilombo/alfandega/anexo.ts'
import { readRefSources } from '../quilombo/alfandega/refs.ts'
