...
import { urlDoOllama } from '../../tomada/harness/ollama-estado.ts'
import { rotuloDoBloqueio } from '../despacho.ts'
import type { Check, Severity } from '../../euclides/radar/doctor.ts'
import { runtimeDeScript } from '../../cordel/alicerce/runtime.ts'

export type { Severity as Severidade, Check as ChecagemDeAmbiente } from '../../euclides/radar/doctor.ts'
