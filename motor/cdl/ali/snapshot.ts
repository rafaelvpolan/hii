import { agentRoles, effortFor, harnessPorNome, modelFor, providerLimits, providerNameFor, providerNames } from '../../tmd/registro.ts'
import { provedoresDisponiveis } from '../../tmd/disponibilidade.ts'
import type { ProvedorDisponivel } from '../../tmd/disponibilidade.ts'
import { JANELA_5H, JANELA_SEMANA, consumoPorProvedor, serieDeCusto } from '../../euc/tsr/consumo.ts'
import { allCards } from '../store.ts'
import { resumoDaSessao } from '../../euc/ias-da-sessao.ts'
import { sessaoParaChamada } from '../../euc/tsr/confianca.ts'
import { dailySpend } from '../../euc/tsr/lacuna.ts'
import { emExecucao } from '../../mir/render/rodape.ts'
import type { AgentRole, HarnessId } from '../../tmd/tipos.ts'
import type { EstadoDaConfig, ItemDoLoop, LedgerDaSessao, LinhaDeProvedor } from '../../mir/render/config/index.ts'
