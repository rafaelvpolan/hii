import { agentRoles, effortFor, modelFor, providerLimits, providerNameFor, providerNames } from '../../../lib/ai/registry'
import { provedoresDisponiveis } from '../../../lib/ai/disponibilidade'
import { planoDoProvedor, temLeitorDePlano } from '../../../lib/ai/planos'
import { estadoDoOllama } from '../../../lib/ai/ollama-estado'
import type { ProvedorDisponivel } from '../../../lib/ai/disponibilidade'
import { JANELA_5H, JANELA_SEMANA, consumoPorProvedor, serieDeCusto } from '../../../lib/ai/consumo'
import { allCards } from '../store'
import { resumoDaSessao } from '../../../lib/runner/ias-da-sessao'
import { sessaoParaChamada } from '../../../lib/runner/cost-trust'
import { dailySpend } from '../../../lib/runner/cost-gap'
import { emExecucao } from '../../../lib/core/render/rodape'
import type { AgentRole, AiProviderName } from '../../../lib/ai/types'
...
import { gastoDoMotorNoIntervalo } from '../../../lib/ai/consumo'
