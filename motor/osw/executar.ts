...
import { clarify, clarifyPorIdeacao, writeClarify } from '../../lib/runner/clarify'
import { planSteps } from './rta/perfil'
import { activeSteps } from '../nmy/config'
import { evaluate } from '../cic/crv/avaliar'
import { readCard, patchCard, repoPath, repoBase } from '../cdl/store'
import { ensureWorktree, refreshFromBase, runGit, settleWorktree, stageAll, worktreeOnBranch, worktreePath } from '../qlb/git'
import type { WorktreeFate } from '../qlb/git'
import { ensureUrl, hasDevServer, inspectUrl, urlPort, stopUrl } from '../cic/crv/url-viva'
import { classifySurface, pedeUrl, type SurfaceVerdict } from './rta/superficie'
import { instrucaoDeAjuste, instrucaoDeConserto, relatoDoAjuste, subirUrlComAjuste, esperarPorPid, subirNoWorktree } from '../cic/rpr/url-ajuste'
import { implement, verifyVisual } from '../cic/agente'
import { resolvedFailure, writeRun } from '../euc/registros'
import { abrirSessao } from '../euc/ias-da-sessao'
import { warnBudgetWithoutGuarantee } from '../euc/tsr/confianca'
import { applyFailurePolicy } from '../cic/rpr/politica'
import { quotaFallbackProviderFor } from '../tmd/registro'
