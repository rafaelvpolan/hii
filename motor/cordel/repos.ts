...
import { ROOT, reposFile } from './alicerce/config.ts'
import { listRepos } from './store.ts'
import { initHicodeHome } from './alicerce/home.ts'
import { syncContract } from './bussola/armazenar.ts'
import type { Contract } from './bussola/tipos.ts'
