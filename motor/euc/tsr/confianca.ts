...
import { classifyFailure } from '../../cic/rpr/classe-de-falha.ts'
import type { AgentRequest, AgentResult, Harness } from '../../tmd/tipos.ts'
import { COST_UNKNOWN } from './custo.ts'
import { emptyUsage } from '../../tmd/uso.ts'
import { patchCard, patchCardWith, readCard } from '../../cdl/store.ts'
