...
import { backoffMsFor } from '../../cic/rpr/politica.ts'
import { readDaemonHealth } from './tick.ts'
import { isActive } from '../../mir/render/phases.ts'
import { PROVEDOR_DESCONHECIDO, lerCota } from '../tsr/cota.ts'
import type { LeituraDeCota } from '../tsr/cota.ts'
