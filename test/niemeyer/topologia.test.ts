...
import { lerTopologia, transicaoPermitida, destinosDe, todasAsTransicoes } from '../../motor/niemeyer/topologia.ts'
import { conferirTransicao, esquecerTopologia, observarDeriva } from '../../motor/niemeyer/deriva-de-transicao.ts'
import { STATUSES } from '../../motor/cordel/index.ts'
import type { Status } from '../../motor/cordel/index.ts'
import { activeSteps } from '../../motor/niemeyer/config.ts'
import { waves as ondas } from '../../motor/niemeyer/lucio/ondas.ts'
