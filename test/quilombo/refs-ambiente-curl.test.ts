...
import { curlArgs, parseHop } from '../../motor/quilombo/alfandega/download.ts'
import type { HopResponse } from '../../motor/quilombo/alfandega/redirect.ts'
import type { AddressPin } from '../../motor/quilombo/alfandega/host.ts'
import { run } from '../../motor/quilombo/git.ts'
import { LOGO } from '../fixtures/rede-falsa.ts'
