...
import { MAX_FILESIZE_BYTES, bytesEmDisco, curlArgs, curlHopFetcher, downloadToFile } from '../../motor/quilombo/alfandega/download.ts'
import type { HopFetcher, HopResponse } from '../../motor/quilombo/alfandega/redirect.ts'
import { refuse } from '../../motor/quilombo/alfandega/url-guard.ts'
