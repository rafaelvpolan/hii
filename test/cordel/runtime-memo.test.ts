...
import { escolhaDeRuntime, esquecerRuntime, runtimeDeScript } from '../../motor/cordel/alicerce/runtime.ts'
import { ENV_RUNTIME } from '../../motor/cordel/alicerce/contrato.ts'
