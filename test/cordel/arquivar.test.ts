...
const A = await import('../../motor/cordel/arquivar.ts')
const { submit, transition } = await import('../../motor/mirante/acoes.ts')
const { allCards, updateCard } = await import('../../motor/cordel/store.ts')
