...
import { probeContract, commandsFor, packageForPath } from '../../motor/cordel/bussola/sondar.ts'
import { syncContract, readContract } from '../../motor/cordel/bussola/armazenar.ts'
