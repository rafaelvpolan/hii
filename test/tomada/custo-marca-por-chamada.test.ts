...
const { runProvider, warnBudgetWithoutGuarantee } = await import('../../motor/euclides/tesouro/confianca.ts')
const { classifyCostGap } = await import('../../motor/euclides/tesouro/lacuna.ts')
