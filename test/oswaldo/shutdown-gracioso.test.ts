...
const fila = await import('../../motor/oswaldo/mutirao/estado-da-fila.ts')
const { lerSaude, respostaDeSaude, subirServidorDeSaude } = await import('../../motor/euclides/radar/servidor.ts')
...
const { categoriaDoErro, enderecoDeSaude } = await import('../../motor/euclides/radar/servidor.ts')
