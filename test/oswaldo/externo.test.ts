...
import { lerAcaoExterna, instrucaoDe } from '../../motor/oswaldo/rota/externo.ts'
import { planSteps } from '../../motor/oswaldo/rota/perfil.ts'
import { classifySurface } from '../../motor/oswaldo/rota/superficie.ts'
