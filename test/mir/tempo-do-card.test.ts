...
import { relatoDeTempo, tempoDeMotorS, tempoDeParedeS, esperaHumanaS } from '../../motor/mir/render/tempo-do-card.ts'
import { accumulatedTotals } from '../../motor/euc/metricas-de-fecho.ts'
import type { Card, Fields, StepMap } from '../../motor/cdl/index.ts'
