...
import { navegarNaTela, alvoDeEntrada } from '../../motor/mir/cli/board-tui.ts'
import { selecionado, selecionar } from '../../motor/mir/cli/estado.ts'
import { providerNameFor } from '../../motor/tmd/registro.ts'
import { aplicar as aplicarIa, ciclarModo } from '../../motor/mir/escolher-ia.ts'
import { newSession } from '../../motor/mir/sessao.ts'
