...
import { handle, newSession, planShown, seguir } from '../../motor/mirante/sessao.ts'
...
import { perguntando, respondido } from '../../motor/mirante/sessao.ts'
...
import { removendo } from '../../motor/mirante/sessao.ts'
...
import { retomando } from '../../motor/mirante/sessao.ts'
...
test('/exit aparece no catalogo de comandos', async () => {
  const { COMMANDS } = await import('../../motor/mirante/sessao.ts')
...
import { escolhendoRepo } from '../../motor/mirante/sessao.ts'
...
import { ALIASES, canonico } from '../../motor/mirante/sessao.ts'
...
import { sincronizarAprovacao, comentando } from '../../motor/mirante/sessao.ts'
...
import { aprovando, comentando as comentandoEm } from '../../motor/mirante/sessao.ts'
