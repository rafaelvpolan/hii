...
import { newInput, keypress, aplicarCompletar } from '../../motor/mirante/tui/input.ts'
import type { InputState } from '../../motor/mirante/tui/input.ts'
...
import { colar, expandir, LIMITE_COLA } from '../../motor/mirante/tui/input.ts'
import { tokenize, marcarCola, ehCola, textoDaCola, agruparColagem } from '../../motor/mirante/tui/keys.ts'
...
import { tokenizeParcial } from '../../motor/mirante/tui/keys.ts'
...
import { inicioDaPalavra, fimDaPalavra } from '../../motor/mirante/tui/input.ts'
...
import { pararNavegacao } from '../../motor/mirante/tui/input.ts'
