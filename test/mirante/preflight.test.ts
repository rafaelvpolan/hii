...
import { bloqueia, checarDependencias, checarIa, preflight } from '../../motor/mirante/cli/preflight.ts'
import type { ChecagemDeAmbiente } from '../../motor/mirante/cli/preflight.ts'
