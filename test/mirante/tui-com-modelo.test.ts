...
import { handle, newSession, sincronizarPergunta } from '../../motor/mirante/sessao.ts'
...
import { renderBoardJanela } from '../../motor/mirante/render/board.ts'
import { pendencia } from '../../motor/mirante/responder.ts'
import { renderPergunta } from '../../motor/mirante/render/clarify.ts'
import { providerNameFor } from '../../motor/tomada/registro.ts'
import { runGatedStep } from '../../motor/ciclo/passo-com-gate.ts'
import type { ExecuteDeps } from '../../motor/oswaldo/executar.ts'
import type { ImplementResult } from '../../motor/cordel/index.ts'
import { createCard, readCard, patchCard, allCards, repoPath } from '../../motor/cordel/store.ts'
