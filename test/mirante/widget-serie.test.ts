...
import { serie, esparklinha, type OpcoesSerie } from '../../motor/mirante/render/widget/serie.ts'
import { severidadeDe, type Severidade } from '../../motor/mirante/render/widget/barra.ts'
