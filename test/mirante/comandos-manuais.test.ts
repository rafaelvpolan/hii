...
} from '../../motor/mirante/comandos-manuais.ts'
import { COMMANDS, handle, newSession } from '../../motor/mirante/sessao.ts'
...
test('INVARIANTE o arranque do daemon chama validarComandosManuais de verdade', async () => {
  ...
  expect(fonte).toContain("from './motor/mirante/comandos-manuais.ts'")
