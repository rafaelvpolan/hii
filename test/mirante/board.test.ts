...
import { renderBoard, renderProjetos, resumirProjetos, idadeDe, legendaPassos } from '../../motor/mirante/render/board.ts'
import { passosDoCard, pulados } from '../../motor/mirante/progresso.ts'
import { phaseLabel } from '../../motor/mirante/render/phases.ts'
import { DEFAULT_STEPS } from '../../motor/niemeyer/config.ts'
import type { Fields, StepMap } from '../../motor/cordel/index.ts'
import type { Passo } from '../../motor/mirante/progresso.ts'
import type { BoardOptions } from '../../motor/mirante/render/board.ts'
...
import { renderPassos, renderLegenda, corDoPasso } from '../../motor/mirante/render/board.ts'
...
import { ordemDoBoard } from '../../motor/mirante/render/board.ts'
...
import { linhasDoBoard, janela, renderBoardJanela } from '../../motor/mirante/render/board.ts'
...
import { abasDe, renderAbas } from '../../motor/mirante/render/board.ts'
