...
import { linhaPropriedades, linhasExecucao, emExecucao, quadroDoGiro, GIRO } from '../../motor/mirante/render/rodape.ts'
...
import { esperandoVoce, linhasEspera } from '../../motor/mirante/render/rodape.ts'
...
import { janelaDaLista } from '../../motor/mirante/render/rodape.ts'
...
import { esperaHumano } from '../../motor/mirante/render/phases.ts'

test('uma definicao so de "esperando voce" — rodape e abas concordam', async () => {
  const { abasDe } = await import('../../motor/mirante/render/board.ts')
  const cards = [
...
import { esperandoEmOutrosProjetos, linhaDeOutrosProjetos } from '../../motor/mirante/render/rodape.ts'
