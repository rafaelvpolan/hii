...
import { resolverResposta, cardsPerguntando } from '../../motor/mirante/responder.ts'
import { renderPergunta, quebrar } from '../../motor/mirante/render/clarify.ts'
import type { ClarifyQuestion, Fields } from '../../motor/cordel/tipos.ts'
...
import { renderRespondidas } from '../../motor/mirante/render/clarify.ts'
