...
import type { ImplementResult, Run } from '../../motor/cordel/index.ts'
...
const { classifyFailure } = await import('../../motor/ciclo/reprise/classe-de-falha.ts')
const { harnessPorNome } = await import('../../motor/tomada/registro.ts')
const { readFailureAttempts } = await import('../../motor/ciclo/reprise/tentativas.ts')
const { writeRun, MOTIVO_SEM_CLASSIFICACAO } = await import('../../motor/euclides/registros.ts')
const { applyFailurePolicy } = await import('../../motor/ciclo/reprise/politica.ts')
const { loteDesde } = await import('../../motor/euclides/tesouro/cota-runs.ts')
