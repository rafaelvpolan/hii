...
import { extractVerdictJson, gateOutcome, timeoutForDiff, withGateRetry } from '../../motor/ciclo/crivo/gate.ts'
...
test('a politica do gate final e a mesma do gate por-step (ambos fail-closed)', async () => {
  ...
  // test/ciclo/passo-com-gate.test.ts (gate que nao concluiu -> passo falha; BLOCKED
