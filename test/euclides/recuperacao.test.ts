...
const { reconcileStranded } = await import('../../motor/oswaldo/mutirao/estado-da-fila.ts')
const { anexarEvento } = await import('../../motor/euclides/eventos.ts')
const { executarComIdempotencia } = await import('../../motor/quilombo/salvo-conduto/idempotencia.ts')
const { orfaosDoCard, temOrfao, prOrfaoDe } = await import('../../motor/quilombo/salvo-conduto/compensacao.ts')
const { faseInterrompida, emAndamento, ultimoPassoConhecido } = await import('../../motor/euclides/recuperar.ts')
