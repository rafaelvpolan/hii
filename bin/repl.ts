...
import { dispatch, rotuloDoBloqueio } from '../motor/mir/despacho'
import type { DispatchIO, SituacaoDeEnvio } from '../motor/mir/despacho'
import { provedoresDisponiveis } from '../motor/tmd/disponibilidade'
import { providerNameFor } from '../motor/tmd/registro'
import { handle, newSession, seguir, perguntando, retomando, sincronizarAprovacao } from '../motor/mir/sessao'
import type { SessionState } from '../motor/mir/sessao'
import { daemonPid, daemonStatus } from '../motor/osw/mtr/daemon'
import { pendencia } from '../motor/mir/responder'
...
import { emExecucao } from '../motor/mir/render/rodape'
import { floorProviders, formatProviders } from '../motor/euc/tsr/lacuna'
import { createApp } from '../motor/mir/tui/app'
import { nodeTerminal } from '../motor/mir/tui/screen'
import { ACC, RESET, color, dim, say, escolherProjeto } from '../motor/mir/cli/saida'
import { larguraUtil, reposRegistrados, todosOsCards } from '../motor/mir/cli/dados'
import { definirModo, modoAtual, selecionado, selecionar } from '../motor/mir/cli/estado'
import { cabecalhoDaTarefa, planoDe } from '../motor/mir/cli/tela-tarefa'
import { dicaDaNavegacao, pintarComando, rodapeDa } from '../motor/mir/cli/rodape-tui'
import { alvoDeEntrada, avisoRepos, completer, corpoDaTela, navegarNaTela } from '../motor/mir/cli/board-tui'
import { ensureDaemon, fleet } from '../motor/mir/cli/comandos'
import { bloqueia, preflight } from '../motor/mir/cli/preflight'
import { definirEstadoDoOllama, sondarOllama } from '../motor/tmd/harness/ollama-estado'
import { etiquetaDoProjeto } from '../motor/mir/render/projeto'
import { renderSugestoes, prefixoComum } from '../motor/mir/render/sugestoes'
import type { GrupoDeSugestao } from '../motor/mir/render/sugestoes'
import { comandosDaIaAtiva, corDaIa } from '../motor/tmd/map/comandos'
import { aplicar as aplicarIa, ciclarModo } from '../motor/mir/escolher-ia'
import { renderAprovacao, verificacaoDoCard } from '../motor/mir/render/aprovacao'
import { renderOpcoesRodape } from '../motor/mir/render/clarify'
import * as core from '../motor/mir/acoes'
